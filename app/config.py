...
# ---------- AI 自动回复 outbox / 持久化任务调度配置 ----------
AI_AUTO_REPLY_OUTBOX_ENABLED = _env_bool("AI_AUTO_REPLY_OUTBOX_ENABLED", False)
AI_AUTO_REPLY_OUTBOX_INTERVAL_SECONDS = int(os.getenv("AI_AUTO_REPLY_OUTBOX_INTERVAL_SECONDS", "10").strip() or "10")
AI_AUTO_REPLY_OUTBOX_BATCH_SIZE = int(os.getenv("AI_AUTO_REPLY_OUTBOX_BATCH_SIZE", "100").strip() or "100")
AI_AUTO_REPLY_OUTBOX_LEASE_SECONDS = int(os.getenv("AI_AUTO_REPLY_OUTBOX_LEASE_SECONDS", "300").strip() or "300")
AI_AUTO_REPLY_OUTBOX_MAX_RETRIES = int(os.getenv("AI_AUTO_REPLY_OUTBOX_MAX_RETRIES", "3").strip() or "3")
AI_AUTO_REPLY_OUTBOX_BACKOFF_1_SECONDS = int(os.getenv("AI_AUTO_REPLY_OUTBOX_BACKOFF_1_SECONDS", "60").strip() or "60")
AI_AUTO_REPLY_OUTBOX_BACKOFF_2_SECONDS = int(os.getenv("AI_AUTO_REPLY_OUTBOX_BACKOFF_2_SECONDS", "300").strip() or "300")
AI_AUTO_REPLY_OUTBOX_COMPENSATION_WINDOW_SECONDS = int(os.getenv("AI_AUTO_REPLY_OUTBOX_COMPENSATION_WINDOW_SECONDS", "900").strip() or "900")
AI_AUTO_REPLY_OUTBOX_BACKLOG_COUNT_THRESHOLD = int(os.getenv("AI_AUTO_REPLY_OUTBOX_BACKLOG_COUNT_THRESHOLD", "100").strip() or "100")
AI_AUTO_REPLY_OUTBOX_BACKLOG_AGE_THRESHOLD = int(os.getenv("AI_AUTO_REPLY_OUTBOX_BACKLOG_AGE_THRESHOLD", "300").strip() or "300")
...
ARK_MODEL = os.getenv("ARK_MODEL", "doubao-seed-2-0-pro-260215").strip()
