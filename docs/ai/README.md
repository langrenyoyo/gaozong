...
| **P1 检查点：8/11 MIGRATED 治理状态** | `architecture/remediation/P1_CHECKPOINT_8_OF_11.md`（commit + evidence + PG pending + Reliability Gap 矩阵）|
...
| AI剪辑 Phase 12 迁入准备（冻结参考） | `13_ai_edit/auto_edit_Phase12_AI剪辑迁入准备审计报告.md` |
| 小高素材库 / 视频增稳（冻结参考） | `13_ai_edit/BrollStudio_空镜素材复用与视频增稳评估报告.md` |
| Phase 12 AI剪辑本地 MVP 历史设计 | `13_ai_edit/2026-07-15_Phase12_AI剪辑本地MVP设计.md`（`FROZEN_BY_CUSTOMER`） |
| Phase 12 Task 12 私有素材闭环冻结规格 | `../superpowers/specs/2026-07-16-phase12-task12-ai-edit-material-library-closed-loop-design.md`（不可执行） |
