...
import { fetchWechatDebug, activateWechatWindow } from "../api";
import { fetchWechatAutoDetectStatus } from "../api";
import {
...
import type { CheckRecord, Staff, WechatAutoDetectStatus, AutomationStatus, DouyinSyncResponse } from "../types";
import type { WechatDebugResult } from "../api";
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-[#8b95a6]">配置销售微信、查看本机 Agent 状态、执行安全测试和查看任务记录</p>
