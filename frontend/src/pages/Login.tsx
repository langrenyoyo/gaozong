...
export default function Login({ onLogin }: LoginProps) {
  ...
  const handleLogin = () => {
    ...
    const adminUsers: Record<string, AppUser> = {
      admin: { account: "admin", role: "super_admin", roleLabel: "超级管理员" },
      operation01: { account: "operation01", role: "operation_admin", roleLabel: "运营管理员" },
      finance01: { account: "finance01", role: "finance_admin", roleLabel: "财务管理员" },
    };

    onLogin(adminUsers[normalized] || { account: normalized || "18578790007", role: "merchant", roleLabel: "商户账号" });
  };
        ...
        <section className="flex h-full flex-col text-white max-[980px]:min-h-[46vh]">
          ...
          <div className="mt-auto max-w-[520px] pb-12 max-[980px]:mt-12 max-[980px]:pb-6">
            ...
            <p className="mt-4 text-sm leading-7 text-slate-300">
              统一处理抖音企业号会话、AI 托管回复、线索沉淀和素材剪辑任务。
            </p>
          </div>
        </section>
