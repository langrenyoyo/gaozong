"""四张 leads/tasks core 表的 dev SQLite / PostgreSQL contrast smoke。"""
...
def main() -> int:
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(prefix="p3_d3_leads_tasks_contrast_") as tmpdir:
    ...
    print("SMOKE_PASS: leads/tasks core SQLite vs PostgreSQL contrast ready")
    return 0
